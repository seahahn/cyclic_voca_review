...
import com.example.vocacyclicreview.VocaLearningCycleAdapter;
...
//                startActivity(intent);
        ...
        SharedPreferences sharedPreferencesVocaName = getSharedPreferences("Vocagroup", MODE_PRIVATE);
...
//                    SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyyMMdd_HH:mm");
                    ...
                    String vocagroupName = EditText_vocagroupModify_vocagroupNameInput.getText().toString();
