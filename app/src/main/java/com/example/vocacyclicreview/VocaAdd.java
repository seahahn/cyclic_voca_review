...
import static com.example.vocacyclicreview.BitmapConverter.BitmapToString;
import static com.example.vocacyclicreview.BitmapConverter.DrawableToString;
        ...
        Button_vocaAdd_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (EditText_vocaAdd_vocagroupArea1Input.getText().toString().isEmpty() &&
                    ...
                    voca.add(new VocaShowItem(vocagroup.isVocagroupAreaSwitch1(), EditText_vocaAdd_vocagroupArea1Input.getText().toString(), (String)ImageView_vocaAdd_imageView1.getTag(), getTime));
                    voca.add(new VocaShowItem(vocagroup.isVocagroupAreaSwitch2(), EditText_vocaAdd_vocagroupArea2Input.getText().toString(), (String)ImageView_vocaAdd_imageView2.getTag(), Integer.toString(0)));
                    for(int i = 0; i < vocaAreaAdapter.getItemCount(); i++){
                        voca.add(new VocaShowItem(vocaAreaAdapter.getItemSide(i), vocaAreaAdapter.getItemText(i), vocaAreaAdapter.getImageTag(i), null));
                    }
