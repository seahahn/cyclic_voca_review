    ...
    private void drawButtons(Canvas c, RecyclerView.ViewHolder viewHolder){
        ...
        //오른쪽으로 스와이프 했을때 (왼쪽에 버튼이 보여지게 될 경우)
         if(buttonsShowedState == ButtonsState.LEFT_VISIBLE){
             RectF leftButton = new RectF(itemView.getLeft(), itemView.getTop() + 35, itemView.getLeft() + buttonWidthWithOutPadding, itemView.getBottom() - 35);
             ...
             RectF rightButton = new RectF(itemView.getRight() - buttonWidthWithOutPadding, itemView.getTop() + 35, itemView.getRight(), itemView.getBottom() - 35);
