...
//        vocagroupPosition = intent.getIntExtra("단어장 포지션", -1);
        ...
        ImageButton_vocaModify_goback.setClickable(true);
        ...
        Button_vocaModify_modify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (EditText_vocaModify_vocagroupArea1Input.getText().toString().isEmpty() &&
                    ...
                    ArrayList<VocaShowItem> voca = new ArrayList<>();
                    voca.add(new VocaShowItem(vocagroup.isVocagroupAreaSwitch1(), EditText_vocaModify_vocagroupArea1Input.getText().toString(), (String)ImageView_vocaModify_imageView1.getTag(), vocaList.get(vocaPosition).get(0).getAddedDate()));
                    voca.add(new VocaShowItem(vocagroup.isVocagroupAreaSwitch2(), EditText_vocaModify_vocagroupArea2Input.getText().toString(), (String)ImageView_vocaModify_imageView2.getTag(), vocaList.get(vocaPosition).get(1).getAddedDate()));
