                        ...
                        switch (which) {
                            case 0:
                                ...
                                if (takePictureIntent.resolveActivity(context.getPackageManager()) != null) {
                                    ...
                                    if (photoFile != null){
                                        Uri photoURI = FileProvider.getUriForFile(context.getApplicationContext(), "com.example.vocacyclicreview.fileprovider", photoFile);
                            ...
                            case 1:
                                ...
                                if (intent.resolveActivity(context.getPackageManager()) != null) {
                                    ...
                                    if (photoFile != null){
                                        Uri photoURI = FileProvider.getUriForFile(context, "com.example.vocacyclicreview.fileprovider", photoFile);
